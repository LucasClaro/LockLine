    ...
    func TouchedInterruptor(pos : CGPoint) {
        ...
        if !navegação.ModulosCompletos[navegação.ModuloOlhando] {
            switch atPoint(pos).name {
                case "1":
                    vibrateLight()
                    (!navegação.Interruptor.switchTela[0]) ? audios["ligado"]?.play() : audios["desligado"]?.play()
                ...
                case "2":
                    vibrateLight()
                    (!navegação.Interruptor.switchTela[1]) ? audios["ligado"]?.play() : audios["desligado"]?.play()
                ...
                case "3":
                    vibrateLight()
                    (!navegação.Interruptor.switchTela[2]) ? audios["ligado"]?.play() : audios["desligado"]?.play()
                ...
                case "4":
                    vibrateLight()
                    (!navegação.Interruptor.switchTela[3]) ? audios["ligado"]?.play() : audios["desligado"]?.play()
                ...
                case "5":
                    vibrateLight()
                    (!navegação.Interruptor.switchTela[4]) ? audios["ligado"]?.play() : audios["desligado"]?.play()
                ...
                case "6":
                    vibrateLight()
                    (!navegação.Interruptor.switchTela[5]) ? audios["ligado"]?.play() : audios["desligado"]?.play()
